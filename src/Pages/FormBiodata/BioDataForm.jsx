...
const BiodataForm = () => {
  ...
  const onSubmit = (data) => {
    axiosSecure
      ...
      .then((response) => {
       ...
       navigate('/dashboard/customer/viewbioData')
          Swal.fire({
            icon: "success",
  ...
  useEffect(() => {
    reset({
      ...
      contactEmail: bioData?.user||user?.email,
    ...
    <div className="bg-white rounded-3xl shadow-xl my-10 p-6 max-w-5xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {/* Profile Image */}
          <div>
            <label className="block font-medium mb-1">Profile Image Link</label>
            <input
              type="text"
